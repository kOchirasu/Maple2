...
internal static class AttributeExtensions {
    public static StatAttribute ToStatAttribute(this string value) {
        return value.ToLower() switch {
            "str" => StatAttribute.Strength,
            "dex" => StatAttribute.Dexterity,
            "int" => StatAttribute.Intelligence,
            "luk" => StatAttribute.Luck,
            "hp" => StatAttribute.Health,
            ...
            "cap" => StatAttribute.CriticalRate,
            "cad" => StatAttribute.CriticalDamage,
            "car" => StatAttribute.CriticalEvasion,
            "ndd" => StatAttribute.Defense,
            "abp" => StatAttribute.PerfectGuard,
            "jmp" => StatAttribute.JumpHeight,
            "pap" => StatAttribute.PhysicalAtk,
            "map" => StatAttribute.MagicalAtk,
            "par" => StatAttribute.PhysicalRes,
            "mar" => StatAttribute.MagicalRes,
            "wapmin" => StatAttribute.MinWeaponAtk,
            "wapmax" => StatAttribute.MaxWeaponAtk,
            "dmg" => StatAttribute.Damage,
            "pen" => StatAttribute.Piercing,
            "rmsp" => StatAttribute.MountSpeed,
            "bap" => StatAttribute.BonusAtk,
            "bap_pet" => StatAttribute.PetBonusAtk,
            _ => throw new ArgumentOutOfRangeException(nameof(value), value, "Invalid StatAttribute."),
        };
    }
    ...
    public static SpecialAttribute ToSpecialAttribute(this string value) {
        return value.ToLower() switch {
            ...
            // "improve_survival_kill_exp" => 171,
            // "improve_survival_time_exp" => 172,
            // "offensive_physicaldamage" => 173,
            // "offensive_magicaldamage" => 174,
