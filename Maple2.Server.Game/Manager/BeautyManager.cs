...
public sealed class BeautyManager : IDisposable {
    ...
    public void AddHair(long uid) {
        ...
        session.Achievement.Update(ConditionType.beauty_style_add, codeLong: hairCopy.Id);
    }
    ...
    public bool EquipSavedCosmetic(long uid) {
        ...
        session.Achievement.Update(ConditionType.beauty_style_apply, codeLong: copy.Id);
        return true;
    }
}
