...
public abstract partial record ItemAppearance([JsonDiscriminator] ItemAppearance.Discriminator Type, EquipColor Color) {
    
    public enum Discriminator { Default, Hair, Decal, Cap }
}

[JsonDiscriminatorFallback]
public record ColorAppearance(EquipColor Color) : ItemAppearance(Discriminator.Default, Color) {
...
public record HairAppearance(EquipColor Color, float BackLength, Vector3 BackPosition1, Vector3 BackPosition2,
...
public record DecalAppearance(EquipColor Color, float Position1, float Position2, float Position3, float Position4)
...
public record CapAppearance(EquipColor Color, Vector3 Position1, Vector3 Position2, Vector3 Position3,
