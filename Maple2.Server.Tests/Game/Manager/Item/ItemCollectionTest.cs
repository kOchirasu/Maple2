...
public class ItemCollectionTest {
    ...
    private static Model.Game.Item CreateItem(int id, int rarity = 1, int amount = 1) {
        var fakeProperty = new ItemMetadataProperty(false, 0, 100, 18, 0, ItemTag.None, 0, 0, 0, 0, 0, 0, 0, 0, false);
        var fakeLimit = new ItemMetadataLimit(Gender.All, 0, 0, 4, true, true, true, true, true, false, false, Array.Empty<JobCode>());
        var fakeMetadata = new ItemMetadata(id, $"{id}", Array.Empty<EquipSlot>(), "", 0, fakeProperty, fakeLimit, null, null, null, null, null);
