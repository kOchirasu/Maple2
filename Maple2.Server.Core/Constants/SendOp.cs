...
public static class SendOp {
    public const ushort
        ...
        FURNISHING_STORAGE = 0x0023,
        FURNISHING_INVENTORY = 0x0024,
        ITEM_PUT_ON = 0x0025,
        ITEM_PUT_OFF = 0x0026,
        ITEM_SKIN_PUT_ON = 0x0027,
        ITEM_SKIN_PUT_OFF = 0x0028,
        ITEM_DROP = 0x0029, // does not exist?
        ITEM_UPDATE = 0x002A,
        ...
        REVIVAL = 0x0035,
        REVIVAL_COUNT = 0x0036,
        USER_STATE = 0x0037,
        EXP_UP = 0x0038,
        LEVEL_UP = 0x0039,
        MESO = 0x003A,
        MERET = 0x003B,
        CURRENCY_TOKEN = 0x003C,
        SKILL_USE = 0x003D,
        SKILL_DAMAGE = 0x003E,
        SKILL_SYNC = 0x003F,
        SKILL_CANCEL = 0x0040,
        ...
        ITEM_SOCKET_EXPANSION_SCROLL = 0x00E6, // Also repackage...
        DICE_GAME = 0x00E7,
        BYPASS_KEY = 0x00E8,
        NPC_NOTICE = 0x00EA,
        LOCAL_CAMERA = 0x00EB,
        ...
        IN_GAME_RANK = 0x00F0,
        RESET_CAMERA = 0x00F1,
        DUNGEON_WAITING = 0x00F2,
        ONE_TIME_EFFECT = 0x00F3,
        CAMERA_INTERPOLATION = 0x00F4,
        TIME_SCALE = 0x00F5,
        ...
        HOME_INVITE = 0x00FA,
        TASK_EVENT = 0x00FB,
        STATE_FISHING_DATA = 0x00FC,
        DUNGEON_REVIVE_COUNT = 0x00FD,
        CHANGE_BACKGROUND = 0x0100,
        ROOM_STAGE_DUNGEON = 0x0101,
        DUNGEON_MISSION = 0x0102,
        BUDDY_EMOTE = 0x0104,
        BIND_ITEM = 0x0105,
        TRANSFER_ENCHANT = 0x0106,
        AD_BALLOON = 0x0107,
        GM_COMMAND = 0x0108,
        GLAMOUR_ANVIL = 0x0109,
        PET_SKIN_BADGE = 0x010A,
        DUNGEON_HELP = 0x010B,
        MENTOR = 0x010C,
        SKILL_BOOK_TREE = 0x010E,
        BUDDY_BADGE = 0x0110,
        SYNC_WORLD = 0x0112,
        BIRTHDAY_CARD = 0x0113,
        SUPER_WORLDCHAT = 0x0114,
        MICROGAME = 0x0116,
        REACTOR = 0x0117,
        SURVIVAL_EVENT = 0x0118,
        MERET_USE = 0x0119,
        HALLOWEEN_EVENT = 0x011A,
        SURVIVAL = 0x011B,
        SPECTATE_MUSHTOPIA = 0x011C,
        LAPENSHARD = 0x011D,
        PRESTIGE = 0x011E,
        UGD = 0x011F,
        ...
        MSG_BOX = 0x0124,
        WARDROBE = 0x0125,
        DYNAMIC_BANWORD = 0x0126,
        REQUEST_SYSTEM_INFO = 0x0127,
        CHAT_STAMP = 0x0128,
        WEDDING = 0x012A,
        WEDDING_BILLBOARD = 0x012C,
        HIDE_AND_SEEK = 0x012D,
        MESSENGER_BROWSER_STAMP = 0x012E,
        LIMIT_BREAK = 0x0130;
}
